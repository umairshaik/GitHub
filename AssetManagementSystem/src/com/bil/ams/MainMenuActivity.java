...
import com.bil.ams.fragments.HelpFragment;
import com.bil.ams.fragments.MainMenuFragment;
import com.bil.ams.fragments.ManageLocationFragment;
import com.bil.ams.fragments.SettingsMenuFragment;
...
public class MainMenuActivity extends Activity {
	...
	private void selectItem(int position) {
		...
		case 0:
			MainMenuFragment mainMenuFragment = MainMenuFragment.getInstance();
		...
		case 1:
			SettingsMenuFragment settingsMenuFragment = SettingsMenuFragment
					.getInstance();
			if (settingsMenuFragment.isAdded()) {
				fragmentTransaction.show(settingsMenuFragment);
			} else {
				fragmentTransaction.replace(R.id.content_frame,
		...
		case 2:
			ManageLocationFragment manageLocationFragment = ManageLocationFragment
					.getInstance();
			if (manageLocationFragment.isAdded()) {
				fragmentTransaction.show(manageLocationFragment);
			} else {
				fragmentTransaction.replace(R.id.content_frame,
						manageLocationFragment);
			}
			break;
